...
func (pq *PaymentQuery) QueryReviews() *ReviewQuery {
...
func (pq *PaymentQuery) First(ctx context.Context) (*Payment, error) {
	nodes, err := pq.Limit(1).All(newQueryContext(ctx, TypePayment, "First"))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (pq *PaymentQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = pq.Limit(1).IDs(newQueryContext(ctx, TypePayment, "FirstID")); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (pq *PaymentQuery) Only(ctx context.Context) (*Payment, error) {
	nodes, err := pq.Limit(2).All(newQueryContext(ctx, TypePayment, "Only"))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (pq *PaymentQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
	if ids, err = pq.Limit(2).IDs(newQueryContext(ctx, TypePayment, "OnlyID")); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (pq *PaymentQuery) All(ctx context.Context) ([]*Payment, error) {
	ctx = newQueryContext(ctx, TypePayment, "All")
	if err := pq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (pq *PaymentQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
	ctx = newQueryContext(ctx, TypePayment, "IDs")
...
func (pq *PaymentQuery) Count(ctx context.Context) (int, error) {
	ctx = newQueryContext(ctx, TypePayment, "Count")
	if err := pq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (pq *PaymentQuery) Exist(ctx context.Context) (bool, error) {
	ctx = newQueryContext(ctx, TypePayment, "Exist")
...
func (pq *PaymentQuery) WithReviews(opts ...func(*ReviewQuery)) *PaymentQuery {
	query := (&ReviewClient{config: pq.config}).Query()
...
//		GroupBy(payment.FieldRequestID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (pq *PaymentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Payment, error) {
	...
	if query := pq.withReviews; query != nil {
		if err := pq.loadReviews(ctx, query, nodes,
			func(n *Payment) { n.Edges.Reviews = []*Review{} },
			func(n *Payment, e *Review) { n.Edges.Reviews = append(n.Edges.Reviews, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PaymentQuery) loadReviews(ctx context.Context, query *ReviewQuery, nodes []*Payment, init func(*Payment), assign func(*Payment, *Review)) error {
	...
	query.Where(predicate.Review(func(s *sql.Selector) {
		s.Where(sql.InValues(payment.ReviewsColumn, fks...))
	}))
...
func (pgb *PaymentGroupBy) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypePayment, "GroupBy")
...
func (ps *PaymentSelect) Scan(ctx context.Context, v any) error {
	ctx = newQueryContext(ctx, TypePayment, "Select")
